    ...
    <View style={styles.container1}>
      ...
      <ScrollView style={{ flex: 1, paddingHorizontal: 15, paddingVertical: 20 }}>
       <View style={styles.main}>
             <View style={{height:114,width:114,backgroundColor:'#918f99',borderRadius:57,alignItems:'center',justifyContent:'center'}}>
            ...
            <View style={styles.main1}>
              <RNPickerSelect
                ...
                style={styles.rn}
                value={
                  selectedItems == 0 || selectedItems == null
                    ? ''
                    : selectedItems
                }  
        ...
        <View style={{ marginTop: 20, marginHorizontal: 110, marginBottom:60}}>
          ...
          <Text style={{marginLeft:18,marginTop:12,fontSize:10}}>DELETE CUSTOMER</Text>
        </View>
      </ScrollView>
      <StatusBar />
      <Buttom />
